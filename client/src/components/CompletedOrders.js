...
<option value="daily">Today</option>
   ...
   <table className='table w-[100%] overflow-scroll-x'>
     ...
     <th className='font-semibold w-[100%] px-[20px] py-[5px]'>Completed on</th>
     ...
     <tbody>
       ...
       <td className='font-semibold w-[200px] px-[20px] py-[5px]'>Fredo Gladroff</td>
       ...
       <td className='font-semibold w-[100%] px-[20px] py-[5px]'>10|3|22</td>
       ...
       <tr className='text-left w-[100%] text-black border-[rgba(0,0,0,0.1)] border-2'>
       <td className='font-semibold w-[200px] px-[20px] py-[5px]'>John Green</td>
       <td className='font-semibold w-[100%] px-[20px] py-[5px]'>EM016f89</td>
       <td className='font-semibold w-[100%] px-[20px] py-[5px]'>Berline</td>
       <td className='font-semibold w-[100%] px-[20px] py-[5px]'>236577</td>
       <td className='font-semibold w-[100%] px-[20px] py-[5px]'>90</td>
       <td className='font-semibold w-[100%] px-[20px] py-[5px]'>1|4|22</td>
